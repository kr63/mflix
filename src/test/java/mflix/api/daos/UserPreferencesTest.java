...
public class UserPreferencesTest extends TicketTest {
    ...
    public void testUpdateSinglePreferences() {
        ...
        Assert.assertTrue(
                "The response of the updateUserPreferences should result in true." +
                        " Check your implementation of this method",
        ...
        Assert.assertEquals(
                "The number of keys in the user preferences does not match the expected." +
                        " Check update object",
                1,
